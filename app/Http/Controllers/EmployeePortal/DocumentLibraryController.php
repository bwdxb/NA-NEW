...
class DocumentLibraryController extends Controller
{
    ...
    public function fetch(Request $request)
    {
        ...
        return view('employee_portal.employee_document_library', ['data' => $documents,'document_type'=>$document_type]);
    }
...
//                    'created_by' => 1,
    ...
    public function update($id)
    {
        ...
        $data = DocumentLibrary::orderBy('created_at', 'desc')->paginate(8);
        // dd($docs);
        return view('employee_portal.document_library', ['update' => $docs, 'data' => $data]);
