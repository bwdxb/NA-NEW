...
@section('content')
                        ...
                        <div class="container-fluid">
                            <div class="row mb-2">
                                <div class="col-sm-6 mt-4">
                                    <h1 class="m-0 text-dark">The Market place list</h1>
                                </div><!-- /.col -->
                            </div><!-- /.row -->
                        </div><!-- /.container-fluid -->
                    </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped adminTable">
                                                    ...
                                                    @forelse($data as $d)
                                                        <tr>
                                                            <td>
                                                                <img src="{{ $d->itemCoverImage()?url($d->itemCoverImage()->file_url):'' }}"
                                                                     alt="Product Image">
                                                            </td>
                                                            ...
                                                            <td class="actionbtn">
                                                            @php
                                                        $tempDelUrl=route('employee-portal.market-place.view.admin.delete',['id'=>$d->id]);
                                                        @endphp
                                                                <a class="reject" url="{{$tempDelUrl }}"
                                                                   type="button"
                                                                   onclick="confirmDelete('{{$tempDelUrl}}','')"
                                                                   >
    ...
    <script>
        function confirmDelete(url,title){
                          return  swal({
                        title: "Are you sure?",
                        text: "Are you sure you want to delete your market place product?",
                        icon: "warning",
                        buttons: true,
                        dangerMode: true,
                        })
