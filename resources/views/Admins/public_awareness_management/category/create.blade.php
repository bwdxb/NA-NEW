   ...
   <div class="container-fluid">
      <div class="row mb-2">
         <div class="col-sm-6 mt-4">
            <h1 class="m-0 text-dark">Add Public Awareness Category</h1>
         </div>
...
<section class="content mt-4">
   <div class="container-fluid">
      <form method="post" action="{{ route('public_awareness_category.store')}}" enctype="multipart/form-data" name="addNews" id="addNews">
       {{csrf_field()}}
