   ...
   <div class="container-fluid">
      ...
      <div class="form-group">      
         <div class="row">
            ...
            <div class="col-sm-10">
               <select name="lang" id="lang" class="form-control">
                  ...
                  <option selected="{{(old('lang') == 'English') ? 'selected' : ''}}">English</option>
                  <option selected="{{(old('lang') == 'Arabic') ? 'selected' : ''}}">Arabic</option>
               </select>
            </div>
         </div> 
         <br>     
         <div class="row">
            ...
            <div class="col-sm-10"><select name="cat_id" id="cat_id" class="form-control">
               ...
               <option value="{{$key}}" @if($key==old('cat_id')) selected @endif>{{$category}}</option>
               @endforeach
               </select>
            </div>
         </div>
           ...
           <br />
			...
			<div class="row">
               ...
               <div class="col-sm-10"><input type="text" name="alias" id="alias" class="form-control"  value="{{old('alias')}}"></div>
            </div>
			<br>
			<div class="row">
               <label class="col-sm-2">Date</label>
				...
				<input type="text" readonly="" class="form-control" name="news_date" value="{{old('news_date')}}">
			...
			<div class="row">
               ...
               <div class="col-sm-10"><input type="text" name="video" id="video" class="form-control" value="{{old('video')}}"></div>
            </div>
			<br />
			
			<div class="row">
               <label class="col-sm-2">Short Description</label>
               <div class="col-sm-10"><textarea type="text" name="short_description" class="form-control" id="short_description">   {{old('short_description')}}</textarea></div>
      ...
      <br />
			...
			<div class="row">
               ...
               <div class="col-sm-10"><textarea type="text" name="description" class="form-control" id="description">
               {{old('description')}}
               </textarea></div>
               <div class="clearfix">
               </div>
