			   ...
			   <div class="container-fluid">
				  <div class="row mb-2">
					 <div class="col-sm-6 mt-4">
						<h1 class="m-0 text-dark">Edit Category Course</h1>
					 </div>
...
<section class="content mt-4">
   <div class="container-fluid">
      <form method="post" action="{{route('course_category.update',['id'=>$course->id])}}" enctype="multipart/form-data" class="form-horizontal" id="addOrganizationType">
       {{csrf_field()}}
	   @method('PUT')
