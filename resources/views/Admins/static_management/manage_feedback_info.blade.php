                ...
                <section class="panel">
                        ...
                        <div class="container-fluid">
                            <div class="row mb-2">
                                <div class="col-sm-6 mt-4">
                                    <h1 class="m-0 text-dark">Edit Feedback Info</h1>
                                </div>
                                <div class="col-sm-6 mt-4">
                                    <a class="pull-right btn btn-primary" href="{{route('manage-feedback-info.history',$data->id)}}">History</a>
                                </div>
                    ...
                    <section class="content mt-4">
                        ...
                        <!-- <form method="post" action="{{ route('service.update') }}" enctype="multipart/form-data" -->
                            <form method="post" action="{{ route('cms.manage_feedback.update') }}"
                                  enctype="multipart/form-data" name="addPage" id="addPage">
                                {{ csrf_field() }}
                                    ...
                                    <div class="col-sm-10 pl-5">
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                <img @if(isset($data->banner))
                                                     src="{{ asset(old('image')?old('image'):('public/uploads/feedback/'.$data->banner)) }}"
                                                     @else
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="col-sm-10">
                                        <textarea type="text" name="intro" class="custom_editor form-control"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="col-sm-10">
                                        <textarea type="text" name="intro_ar" class="custom_editor form-control"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="col-sm-10">
                                        <textarea type="text" name="concl" class="custom_editor form-control"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="col-sm-10">
                                        <textarea type="text" name="concl_ar" class="custom_editor form-control"
