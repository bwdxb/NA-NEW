   ...
   <div class="container-fluid">
      <div class="row mb-2">
         <div class="col-sm-6 mt-4">
            <h1 class="m-0 text-dark"style="text-decoration: bold;"><a class="btn btn-primary" href="{{url('/admin/manage-service-info')}}">Back</a>   History</h1>
         </div>
      </div> 
	  <br />
   </div>
   ...
   <div class="container-fluid">
      <table class="table table-bordered table-striped">
         ...
         <tr>
			...
			<td><img src="{{url('public/uploads/service/'.$page->banner)}}" height="50px" width="100px"></td>
            <td>{{$page->intro}}</td>
            <td>{{$page->intro_ar}}</td>
            <td>{{$page->concl}}</td>
            <td>{{$page->concl_ar}}</td>
            ...
            <td >
         <div class="d-table"> <a href="{{route('manage-service-info.revert',$page->id)}}" onclick="return confirm('Are u sure you want to revert this record ?')" class="btn btn-info w-100"> Revert</a>              
               <a href="{{route('manage-service-info.revert',$page->id)}}?preview=1"  class="btn btn-info w-100 mt-1"> View</a>              
         </div>     
         </td>
         </tr>
