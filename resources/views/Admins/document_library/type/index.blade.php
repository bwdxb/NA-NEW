   ...
   <div class="container-fluid">
      <div class="row mb-2">
         <div class="col-sm-6 mt-4">
            <h1 class="m-0 text-dark"style="text-decoration: bold;">Document Type Management</h1>
         </div>
...
<section class="content">
   ...
   <!-- <form method="get" action="">
	  ...
	  <div class="float-sm-right  mb-3">
        <a href="{{ route('document_library.type.create')}}" class="btn btn-primary " style="margin-bottom:5px;">Create Document Type</a>
      </div>
         ...
         @foreach($data as $key=>$document)
          <tr>
              ...
              <td style="min-width:118px;">
                  <a href="{{route('document_library.type.edit',$document->id)}}" class="btn btn-info"> 
    ...
    swal({
         ...
         closeOnConfirm: false,
            ...
            $.ajax({
                  ...
                  url: "/admin/document_library_type/delete/" +id,
                  success: function(data) {
                        swal({
                          ...
                          //timer: 3000
                              ...
                              window.location.replace("{{url('/admin/document_library_type')}}");
                          });
                  }
            });
         });
...
<script>
  function statefunction(id){
        swal({
          ...
          jQuery.ajax({
            type: 'get',
            url:  "{{url('/admin/document_library_type/status')}}/"+id,
            success: function(data) {
                if(data == 1){
