   ...
   <div class="container-fluid">
      <div class="row mb-2">
         <div class="col-sm-6 mt-4">
            <h1 class="m-0 text-dark"style="text-decoration: bold;">Document Library Department Management</h1>
         </div>
...
<section class="content">
   ...
   <!-- <form method="get" action="">
	  ...
	  <div class="float-sm-right  mb-3">
        <a href="{{ route('document_library.department.create')}}" class="btn btn-primary " style="margin-bottom:5px;">Create Document Department</a>
      </div>
     @if(Session::has('message'))
      ...
      <table class="table table-bordered table-striped">
         <tr>
          <th>Sr.No</th>
          <th>Document Library Department</th>	
          <th>Created By</th>
          <th>Updated By</th>
          <th>Created At</th>
          <th>Updated At</th>
         ...
         @foreach($data as $key=>$document)
          ...
          <td>{{($data->perPage() * ($data->currentPage() - 1))+ ($key+1)}}</td>
              ...
              <td style="min-width:118px;">
                  <a href="{{route('document_library.department.edit',$document->id)}}" class="btn btn-info"> 
    ...
    swal({
         ...
         closeOnConfirm: false,
            ...
            $.ajax({
                  ...
                  url: "/admin/document_library_department/delete/" +id,
                  success: function(data) {
                        swal({
                          ...
                          //timer: 3000
                              ...
                              window.location.replace("{{url('/admin/document_library_department')}}");
                          });
                  }
            });
         });
...
<script>
  function statefunction(id){
        swal({
          ...
          jQuery.ajax({
            type: 'get',
            url:  "{{url('/admin/document_library_department/status')}}/"+id,
            success: function(data) {
                if(data == 1){
