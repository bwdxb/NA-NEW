                           ...
                           <tr style="margin-left: 100px;">
                              <td style="padding:30px 50px">
                                 ...
                                 {{__('Dear')}} {{$name}}{{__(',')}}
                                  ...
                                  {{__('Thank you for contacting the National Ambulance Team.')}}</p>
                                  <p style="font-family:'HelveticaNeue-Light','Helvetica Neue Light','Helvetica Neue',Calibri,Helvetica,Arial,sans-serif;font-size:16px;font-stretch:normal;line-height:1.68;color:#3b3e40;margin:0 0 10px; @if(app()->getLocale() != 'en')direction:rtl;text-align:right;@endif">
                                    ...
                                    <p style="font-family:'HelveticaNeue-Light','Helvetica Neue Light','Helvetica Neue',Calibri,Helvetica,Arial,sans-serif;font-size:16px;font-stretch:normal;line-height:1.68;color:#3b3e40;margin:10px 0 0; @if(app()->getLocale() != 'en')direction:rtl;text-align:right;@endif">{{__('Stay safe.')}}</p>
