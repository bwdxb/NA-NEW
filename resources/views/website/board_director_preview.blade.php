					...
					<div class="memberBlock mt-4">
						...
						<div class="listWrapper mt-4">
							...
							<?php for($i =1; $i<count($board_director); $i++){?>
								@if( $isEdit && $new_rec->id==$board_director[$i]->id)

<div class="listItem">
									<figure class="itemImage"><img alt="{{$new_rec->name}}" src="{{url('public/uploads/board_director/'.$new_rec->image)}}"/></figure>
...
@else
								...
								@endif
@if(($new_rec->sequence_number == $i && !$isEdit))
