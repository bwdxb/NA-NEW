...
$.extend($.validator, {
	...
	messages: {
		...
		alphanumeric: "Please enter alphanumeric chracter only.",
		extension: "Please upload file with a valid extension.",
		password: "Please enter Valid Password.",
		digits: "Please enter only digits.",
		notEqual: "Please change Approved Status",
		creditcard: "Please enter a valid credit card number.",
		equalTo: "Please enter the same value again.",
		NotequalTo: "Current password and new password can not be same .",
