function licenseFile() {
    ...
    if ("" == e.value) licensefileLabel.innerHTML = "تحميل الملف";
    else {
        var l = e.value.split("\\");
...
function isoFile() {
    ...
    if ("" == e.value) isofileLabel.innerHTML = "تحميل الملف";
    else {
        var l = e.value.split("\\");
...
function isoFile1() {
    ...
    if ("" == e.value) isofileLabel1.innerHTML = "تحميل الملف";
    else {
        var l = e.value.split("\\");
...
function isoFile2() {
    ...
    if ("" == e.value) isofileLabel2.innerHTML = "تحميل الملف";
    else {
        var l = e.value.split("\\");
...
function certificationsFile() {
    ...
    if ("" == e.value) equfileLabel.innerHTML = "تحميل الملف";
    else {
        var l = e.value.split("\\");
...
function licenceFile2() {
    ...
    if ("" == e.value) licenceLabel.innerHTML = "تحميل الملف";
    else {
        var l = e.value.split("\\");
...
function formFile() {
    ...
    if ("" == e.value) formFileLabel.innerHTML = "تحميل الملف";
    else {
        var l = e.value.split("\\");
...
function MSDCfile() {
    ...
    if ("" == e.value) MSDCfileLabel.innerHTML = "تحميل الملف";
    else {
        var l = e.value.split("\\");
...
//     if ("" == e.value) patientfileLabel.innerHTML = "تحميل الملف";
//     else {
//         var l = e.value.split("\\");
...
//     if ("" == e.value) reportfileLabel.innerHTML = "تحميل الملف";
//     else {
//         var l = e.value.split("\\");
...
//     if ("" == e.value) supportFileLabel.innerHTML = "تحميل الملف";
//     else {
//         var l = e.value.split("\\");
...
$(".logoSlider").slick({
    ...
    variableWidth: !1,
    rtl: !0
}), $(".customTabs .nav-link").removeAttr("style"), EmiratePassport_files = function() {
    for (var e = document.getElementById("passport_files"), l = document.getElementById("fileList"), i = "", n = 0; n < e.files.length; ++n) i += "<li>" + e.files.item(n).name + "</li>";
    l.innerHTML = '<ul class="file_list">' + i + "</ul>"
}, $("select").children('option[value="Ms"]').remove();
